...
namespace WebApi.Tools.PersianError
{
    public class PersianIdentityErrors : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"این شماره موبایل قبلا ثبت شده است" }; }
