...
namespace Persistence.Store.AdminSection.Products.Queries
{
    public class CheckUsedProductInAnySefareshQueryHandler : IRequestHandler<CheckUsedProductInAnySefareshQuery, bool>
    {
        ...
        {
            var variantIds_SampleOrVariable = await _context.ProductVariants.IgnoreQueryFilters()
            ...
            var used = await _context.SymbolicOrderOrSymbolicShoppingCartItems.IgnoreQueryFilters()
