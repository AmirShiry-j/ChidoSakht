...
namespace Application.Store.AdminSection.ProductAttribute.Commands
{
    ...
    public class DeleteProductAttributeValueCommand : IRequest
    {
        ...
        public DeleteProductAttributeValueCommand(ProductAttributeValue productAttributeValue)
        {
    ...
    public class UpdateProductAttributeValueCommand : IRequest
    {
        ...
        public UpdateProductAttributeValueCommand(ProductAttributeValue productAttributeValue)
        {
            ProductAttributeValue = productAttributeValue;
        }
    }
